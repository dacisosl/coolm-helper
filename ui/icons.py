...
_PATHS = {
    ...
    # 🏫 학교 건물 (초록) — 학사일정 가져오기
    "school": ('<path d="M12 2 2 7v2h20V7L12 2zm-7 9v7H3v2h18v-2h-2v-7h-2v7'
               'h-3v-7h-2v7H8v-7H5z" fill="#2e7d32"/>'
               '<circle cx="12" cy="6.4" r="1.5" fill="#ffffff"/>'),
    # 💬 말풍선 (파랑)
    ...
    # – 트레이로 최소화 (회색, 아래쪽 바 — 위젯 헤더용)
    "minimize": ('<rect x="5" y="17" width="14" height="3" rx="1.5" '
                 'fill="#78859a"/>'),
    # ☰ 상세보기 목록 (회색, view_list 모양 — 플래너 헤더 토글)
    "list": ('<g fill="#78859a"><rect x="3" y="5" width="4" height="3" rx="1"/>'
             '<rect x="9" y="5" width="12" height="3" rx="1"/>'
             '<rect x="3" y="10.5" width="4" height="3" rx="1"/>'
             '<rect x="9" y="10.5" width="12" height="3" rx="1"/>'
             '<rect x="3" y="16" width="4" height="3" rx="1"/>'
             '<rect x="9" y="16" width="12" height="3" rx="1"/></g>'),
